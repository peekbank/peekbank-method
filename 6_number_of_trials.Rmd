...
cutoff_rt |> filter(pairs>4) |> ggplot(aes(x = min, y = cor_rt, col = age_bin)) +
  scale_color_viridis(discrete = T) +
  stat_summary(position = position_dodge(.5)) +
  stat_summary(position = position_dodge(.5), geom = "line") +
  geom_hline(yintercept = 0)

cutoff_rt |> filter(pairs>4) |> ggplot(aes(x = min, y = cor_rt)) +
    stat_summary(position = position_dodge(.5)) +
  stat_summary(position = position_dodge(.5), geom = "line") +
  geom_hline(yintercept = 0)
...
ggplot(cutoff_acc |> filter(pairs>4), aes(x = min, y = cor_acc, col = age_bin)) +
  scale_color_viridis(discrete = T) +
  stat_summary(position = position_dodge(.5)) +
  stat_summary(position = position_dodge(.5), geom = "line") +
  geom_hline(yintercept = 0)
