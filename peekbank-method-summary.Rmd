...
acc_trial_all <- excl1 |> mutate(Type="ICC reliability") |> rename(estimate=icc) |> 
  ...
  bind_rows(excl1_cdi |> rename(estimate=cor_prod) |> mutate(Type="Corr. with CDI Production")) |> 
